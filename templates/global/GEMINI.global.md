...
## Gemini / Agy Specialization

Gemini CLI / Agy 适合长上下文批处理、低成本草稿、备用 code review、批量分类和第一遍扫描。输出必须可验证，主 agent 只做最小验收；不要让它们处理 secrets、signing、payment、destructive actions。
