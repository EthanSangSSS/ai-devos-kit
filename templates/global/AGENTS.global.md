...
- The surface Ethan opened owns the task and final verification. Use its available capabilities directly. Delegate only for an actual capability gap or explicit task-level request; state the reason and never silently change executor/model.
