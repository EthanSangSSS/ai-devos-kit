#!/usr/bin/env bash
# Purpose: Prepare iOS simulator QA for Flutter app without claiming visual acceptance.
# Usage: bash scripts/ios_simulator_qa_prep.sh
...
Prepare iOS simulator QA for Flutter app without claiming visual acceptance.
EOF
}
...
has flutter && echo "Suggested: flutter build ios --simulator --debug" || warn "flutter missing"
